		...
		<div className="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2">
			...
			<div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-slate-950 text-white p-12">
				...
				<Link to="/" className="relative">
					<img src={logo} alt="OmniCart" className="h-12 w-auto brightness-0 invert" />
				</Link>
				...
				<div className="relative max-w-md">
					...
					<p className="mt-4 text-slate-300">
						Sign in to shop, manage your store, or oversee the platform —
						all from one beautiful account.
					</p>
					...
					<form className="mt-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
						...
						<div>
							<div className="flex items-center justify-between mb-1.5">
								...
								<Link to="/forgot" className="text-sm text-brand-600 hover:text-brand-700">
									Forgot?
								</Link>
							</div>
							<div className="relative">
