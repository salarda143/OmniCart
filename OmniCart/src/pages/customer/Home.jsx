  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative bg-slate-950 text-white">
        ...
        <div className="absolute -bottom-32 -right-16 w-md h-112 rounded-full bg-accent-500/30 blur-3xl animate-blob [animation-delay:-6s]" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 py-16 sm:py-24 md:py-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block animate-float">
            <div className="absolute inset-0 bg-linear-to-tr from-brand-500 to-accent-500 rounded-4xl blur-2xl opacity-40" />
            <div className="relative bg-white/10 backdrop-blur-xl border border-white/15 rounded-4xl p-6 shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-10 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {categories.map((cat) => (
              ...
              >
                <div
                  className={`grid place-items-center w-14 h-14 rounded-2xl bg-linear-to-br ${cat.color} text-white shadow-md`}
                >
      ...
      <section className="px-4 sm:px-8 pb-8">
        <div className="max-w-7xl mx-auto relative overflow-hidden rounded-3xl bg-linear-to-br from-brand-600 to-brand-800 px-6 sm:px-12 py-14 sm:py-16 text-center text-white">
