...
function Footer() {
  return (
    <footer className="relative mt-24 bg-slate-950 text-slate-300">
      <div className="absolute inset-x-0 -top-px h-1 bg-linear-to-r from-brand-500 via-accent-500 to-brand-500" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 grid gap-6 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-2 text-slate-400 text-sm">
              Get the latest drops, deals, and seller tips — straight to your
              inbox.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="mt-4 text-sm text-slate-400 leading-relaxed">
            Your complete digital marketplace connecting buyers and sellers in
            one beautiful place.
          </p>
